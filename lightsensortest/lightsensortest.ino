...
int portStart = 0; //refers to analog pin 0 A0
int portEnd = 1; //change to the last analog pin attached A5
...
void loop() {
  readingZero = analogRead(0);
  readingOne = analogRead(1);
